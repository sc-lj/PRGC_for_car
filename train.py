...
parser.add_argument('--corpus_type', type=str, default="CarFaultRelation",
                    help="NYT, WebNLG, NYT*, WebNLG*, CarFaultRelation")
...
parser.add_argument('--ensure_corres', default=True,
                    help="correspondence ablation")
parser.add_argument('--ensure_rel', default=True,
